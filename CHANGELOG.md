...
- Rebranded to AndroidForensic Everywhere
- Restructured package from `andriller` to `androidforensic`
- Decoupled core modules from Tkinter to support multiple interfaces
- Added responsive web interface (Flask + Vanilla CSS/JS) with real-time SSE streaming
- Added modern keyboard-driven Terminal User Interface (Textual)
- Added command line interface (Click + Rich)
- Migrated test suite to `androidforensic` and fully updated all configurations
