...
- Select individual databases or all to decrypt.
...
DEFAULT_HEADER = '<font color="#FF0000" size="">This report was generated using AndroidForensic Everywhere (This field is editable in Settings)</font>'

DEFAULT_FOOTER = '<i>AndroidForensic Everywhere (This field is editable in Settings)</i>'
